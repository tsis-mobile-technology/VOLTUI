...
/* Controllers */
	...
	myCtrl.controller('MyCtrl_dashboard', ['$scope',  '$http', 'requestHTTP', function($scope, $http, requestHTTP) {
		...
		if($("#stats-chart2").length) {				
			...
			requestHTTP.getJsonCrossdomainCallback("test.jsp", "", setVisits, onStatsChart2Fail);
			requestHTTP.getJsonCrossdomainCallback("test1.jsp", "", setPageviews, onStatsChart2Fail);
			requestHTTP.getJsonCrossdomainCallback("test2.jsp", "", setVisitors, onStatsChart2Fail);
			requestHTTP.getJsonCrossdomainCallback("test3.jsp", "", setNewVisitors, onStatsChart2Fail);
